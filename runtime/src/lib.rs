...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("my-first-substrate-test"),
	impl_name: create_runtime_str!("my-first-substrate-test"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		AtestModule: atest::{Module, Call, Storage, Event<T>},
	}
);
